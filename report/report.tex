...
\paragraph{Reading the result through the Bregman representation.} By
...
\paragraph{Reading the result through the Bregman representation.} The ordering of these
...
\paragraph{Reading the result through the Bregman representation.} The widening ratio is
...
\paragraph{Reading the result through the Bregman representation.} Strict properness
...
\paragraph{Reading the result through the Bregman representation.} Experiment 5 closes
